...
class SalariesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('name', function (Salary  $model) {
                return $model->user->name;
            })
            ->addColumn('action', function (Salary  $model) {
                return view('pages.salaries._action-menu', compact('model'));
            });
    }
...
>")
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name')->title('الموظف'),
            Column::make('amount')->title('الراتب'),
