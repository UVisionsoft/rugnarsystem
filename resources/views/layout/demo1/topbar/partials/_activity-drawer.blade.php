	...
	<div class="card shadow-none">
		...
		<div class="card-header" id="kt_activities_header">
			...
			<div class="card-toolbar">
				<button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-n5" id="kt_activities_close">
					{!! theme()->getSvgIcon("icons/duotone/Navigation/Close.svg", "svg-icon-1") !!}
				</button>
			</div>
		</div>
		<!--end::Header-->
		...
		<div class="card-footer py-5 text-center" id="kt_activities_footer">
			<a href="{{ theme()->getPageUrl('pages/profile/activity') }}" class="btn btn-bg-white text-primary">
				View All Activities {!! theme()->getSvgIcon("icons/duotone/Navigation/Right-2.svg", "svg-icon-3 svg-icon-primary") !!}
			</a>
		</div>
		<!--end::Footer-->
	</div>
